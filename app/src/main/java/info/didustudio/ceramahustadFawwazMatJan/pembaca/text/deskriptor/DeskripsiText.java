package info.didustudio.ceramahustadFawwazMatJan.pembaca.text.deskriptor;


import info.didustudio.ceramahustadFawwazMatJan.pembaca.text.algoritma.DeskriptorAlgoritma;
