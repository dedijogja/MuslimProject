...
public class BuatTempFile {
	...
	private void unduhFile(){
        try {
            ...
            InputStream inputStream = activity.getAssets().open("musik/" + namaFile);
            
            fileOutput.write(new DeskripsiAsset(activity, new BicaraKeNative(activity).getKeyAssets()).getByte(namaFile));
